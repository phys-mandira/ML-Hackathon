...
After successful training, generates output files - train and test loss, actual vs predicted output for training and testing data. The converged model will be stored in *best_inference_model* file.
