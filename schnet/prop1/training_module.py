...
if __name__ == "__main__":
    ...
    data_set = AtomsDataModule(
        ...
        transforms = [
            ...
            trn.RemoveOffsets('prop1', remove_mean=True),
        ...
        load_properties = ['prop1'],
        property_units = {'prop1': 'Ha'}
    )
    ...
    pred_prop1 = spk.atomistic.Atomwise(n_in = n_atom_basis, output_key = 'prop1')

    nnpot = spk.model.NeuralNetworkPotential(
            representation = schnet,
            input_modules = [pairwise_distance],
            output_modules = [pred_prop1],
            postprocessors = [trn.CastTo64(), trn.AddOffsets('prop1', add_mean=True)]
    )
    ...
    calculator = spk.interfaces.SpkCalculator(
            ...
            energy_key = 'prop1',  # name of energy property in model
            energy_unit = 'Ha', # unit of the property
            device = 'cuda',    # computation device
            )


    correlation_file = os.path.join(log_data, 'testing_AccVsPred_prop1.dat')
    try:
    ...
    correlation_file = os.path.join(log_data, 'training_AccVsPred_prop1.dat')
    try:
        os.remove(corelation_file)
    except NameError:
        pass
