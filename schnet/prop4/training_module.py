...
if __name__ == "__main__":
    ...
    data_set = AtomsDataModule(
        ...
        transforms = [
            ...
            trn.RemoveOffsets('prop4', remove_mean=True),
        ...
        load_properties = ['prop4'],
        property_units = {'prop4': 'Ha'}
    )
    ...
    pred_prop4 = spk.atomistic.Atomwise(n_in = n_atom_basis, output_key = 'prop4')

    nnpot = spk.model.NeuralNetworkPotential(
            representation = schnet,
            input_modules = [pairwise_distance],
            output_modules = [pred_prop4],
            postprocessors = [trn.CastTo64(), trn.AddOffsets('prop4', add_mean=True)]
    )

    #output model parameters
    output_prop4 = spk.task.ModelOutput(
            name = 'prop4',
    ...
    calculator = spk.interfaces.SpkCalculator(
            ...
            energy_key = 'prop4',  # name of energy property in model
            energy_unit = 'Ha', # unit of the property
            device = 'cuda',    # computation device
            )


    correlation_file = os.path.join(log_data, 'testing_AccVsPred_prop4.dat')
    try:
    ...
    for i in range(500):
        ...
        prop4_acc = test_data["prop4"][i] 
        atoms = Atoms(symbols = symbols, positions = positions)

        tmp.append(prop4_acc[0])
    ...
    correlation_file = os.path.join(log_data, 'training_AccVsPred_prop4.dat')
    try:
        os.remove(corelation_file)
    except NameError:
        pass
